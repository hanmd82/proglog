...
import (
	...
	. "github.com/hanmd82/proglog/internal/discovery"
...
// setupMember() is a helper method that sets up a new member under a free port and
// with the member’s length as the node name
